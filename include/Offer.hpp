...
public:
    ...
    virtual std::optional<OfferStatus> getOfferStatus() const = 0;
    ...
    /** Refer to {@link #getOfferStatus()}. */
    virtual void setOfferStatus(std::optional<OfferStatus> offerStatus) = 0;
