...
public:
    ...
    /** Get the final payment object. */
    virtual std::shared_ptr<Payment> getPayment() const = 0;

    /**
     * Get the receipt associated with the payment. This is the same object
     * returned from the payment object.
     */
    virtual std::shared_ptr<Receipt> getReceipt() const = 0;
};
