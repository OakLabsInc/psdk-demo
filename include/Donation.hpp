...
// This file generated by Djinni from Donation.djinni
...
/**
 * Donation represents the data that is shared between the terminal and the Android application.
 ...
 */
class PSDK_EXPORT Donation {
public:
    virtual ~Donation() {}

    /** Create Donation */
    static std::shared_ptr<Donation> create();
