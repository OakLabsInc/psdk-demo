...
public:
    ...
    /** Refer to {@link #setTransactionId(String transactionId)} */
    ...
    /**
     * Sets the ID for this transaction. This is generated by the system if not provided,
     * and cannot be changed. This is primarily used for audit purposes.
     */
